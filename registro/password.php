                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="password.php" method="POST">
                                            ...
                                            <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
                                               <button type="submit" class="btn btn-primary btn-sm btn-block" name="A">
                                               <img class="img-reponsive img-rounded" src="../icons/apps/accessories-text-editor.png" /> Blanquear Password</button><hr>
                                            </div>
                                        </form>
