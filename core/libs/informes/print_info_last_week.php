...
<div>
   ...
   <div class="row">
    ...
    <h3 align="center">Expedientes Ingresados en la Ultima Semana</h3>
   ...
   <?php 
       ...
       if($conn){
        ...
        $sql = "select nro_exp, fecha_ingreso, asunto, procedencia, usuario_responsable from exp_expedientes where fecha_ingreso between date_sub(now(), interval 1 week) and now()";
        mysqli_select_db($conn,$dbase);
        $query = mysqli_query($conn,$sql);
        $count = 0;
