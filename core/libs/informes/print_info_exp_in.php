...
<div>
   ...
   <div class="row">
    ...
    <h3 align="center">Expedientes en el Area</h3>
   ...
   <?php 
       ...
       if($conn){
        ...
        $sql = "select nro_exp, fecha_ingreso, asunto, procedencia, usuario_responsable, fecha_egreso, destino from exp_expedientes where fecha_ingreso is not null and fecha_egreso IS NULL order by usuario_responsable and fecha_ingreso ASC";
        mysqli_select_db($conn,$dbase);
        $query = mysqli_query($conn,$sql);
        $count = 0;
