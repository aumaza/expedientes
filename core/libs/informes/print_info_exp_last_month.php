...
<div>
   ...
   <div class="row">
    ...
    <h3 align="center">Expedientes Trabajados en el Ultimo mes</h3>
   ...
   <?php 
       ...
       if($conn){
        ...
        $sql = "select nro_exp, fecha_ingreso, asunto, procedencia, usuario_responsable, fecha_egreso, destino from exp_expedientes where fecha_ingreso between date_sub(now(), interval 1 month) and now() order by usuario_responsable and fecha_ingreso ASC";
        mysqli_select_db($conn,$dbase);
        $query = mysqli_query($conn,$sql);
        $count = 0;
